...
namespace WebBanHangAPI.Migrations
{
    ...
    [Migration("20220613154136_ghepmigrationTienCHanh")]
    partial class ghepmigrationTienCHanh
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebBanHangAPI.Models.ChiTietHD", b =>
                {
                    ...
                    b.Property<string>("BinhLuanDanhGia")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("SoSao")
                        .HasColumnType("int");

                    b.Property<int>("TrangThaiDanhGia")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebBanHangAPI.Models.MaGiamGia", b =>
                {
                    b.Property<string>("MaGiamGiaId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<double>("DonToiThieu")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("WebBanHangAPI.Models.MaGiamGiaCuaNgDung", b =>
                {
                    b.Property<string>("MaGiamGiaId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("MaGiamGiaId", "NguoiDungId");

                    b.HasIndex("NguoiDungId");

                    b.ToTable("MaGiamGiaCuaNgDungs");
                });
            ...
            modelBuilder.Entity("WebBanHangAPI.Models.HoaDon", b =>
                {
                    ...
                    b.HasOne("WebBanHangAPI.Models.NguoiDung", "NhanVien")
                        .WithMany("HoaDonsNhanVien")
            ...
            modelBuilder.Entity("WebBanHangAPI.Models.MaGiamGiaCuaNgDung", b =>
                {
                    b.HasOne("WebBanHangAPI.Models.MaGiamGia", "MaGiamGia")
                        .WithMany()
